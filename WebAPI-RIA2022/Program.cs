...
builder.Services.AddDbContext<DataContext>(options => options.UseMySql(Environment.GetEnvironmentVariable("DbConnection"),
...
builder.Services.AddTransient<IDAL_Materias, DAL_Materias_EF>();
builder.Services.AddTransient<IDAL_UnidadesCurriculares, DAL_UnidadesCurriculares_EF>();
builder.Services.AddTransient<IDAL_Previas, DAL_Previas_EF>();


builder.Services.AddTransient<IBL_Noticias, BL_Noticias>();
builder.Services.AddTransient<IBL_Documentos, BL_Documentos>();
builder.Services.AddTransient<IBL_Materias, BL_Materias>();
builder.Services.AddTransient<IBL_UnidadesCurriculares, BL_UnidadesCurriculares>();
builder.Services.AddTransient<IBL_Previas, BL_Previas>();
